...
namespace tests {
    void test_main() {
        test_expression_accept();
        test_expression_binary_expression();
        test_expression_unary_expression();
        test_expression_literal();
        test_expression_grouping();
        test_scanner_scan();
        test_scanner_string();
        test_scanner_identifier();
        test_spectra_error();
        test_spectra_runtime_error();
        test_token_token_data();
        test_parser_expression();
        test_parser_equality();
        ...
        test_parser_match();
        test_parser_check();
        test_interpreter_visit_literal_expression();
        test_interpreter_visit_grouping_expression();
        test_interpreter_visit_unary_expression();
        test_interpreter_visit_binary_expression();
        test_interpreter_evaluate_expression();
        test_interpreter_make_string();
    }
